...
var DocBuilderLive = (function () {
    function DocBuilderLive(specId) {
        ...
        this.getLastModifiedTime = function (callback, errorCallback, retryCount) {
        ...
        */
        this.populateChild = function (id, callback, errorCallback, retryCount) {
            if (typeof retryCount === "undefined") { retryCount = 0; }
            jQuery.ajax({
                type: 'GET',
        ...
        this.expandSpec = function (spec, callback, errorCallback) {
            var expandChildren = function (index) {
        ...
        * @param retryCount An internal count that tracks how many time to retry a particular call
        */
        this.getSpec = function (callback, errorCallback, retryCount) {
            if (typeof retryCount === "undefined") { retryCount = 0; }
            jQuery.ajax({
                type: 'GET',
                url: SERVER + SPEC_REST + _this.specId + "?expand=" + encodeURIComponent(JSON.stringify(SPEC_REST_EXPAND)),
                dataType: "json",
                context: _this,
                success: function (data) {
        ...
        this.getAllChildrenInFlatOrder = function (spec) {
            /*
        ...
        this.getChildrenInOrder = function (parent) {
            /*
            Find the one that has no nextNode
            */
            var lastChild;
        ...
        this.buildIFrameAndDiv = function (element) {
        ...
        this.setIFrameSrc = function (iFrame, delay, count) {
            /*
        ...
        */
        this.getTopics = function (specTopics) {
        ...
        this.buildToc = function (spec) {
            ...
            var children = _this.getChildrenInOrder(spec);
            _.each(children, function (element) {
        ...
        this.startRefreshCycle = function () {
            window.setTimeout(function () {
            }, REFRESH_DELAY);
        };
        this.findUpdatesToSpec = function () {
            var errorCallback = function (title, message) {
                _this.startRefreshCycle();
            };

            _this.getLastModifiedTime(function (lastRevisionDate) {
                _this.findUpdatedSpec(function (spec) {
                    ...
                    */
                    if (spec.items.length !== 0 && new Date(spec.items[0].item.lastModified) > _this.lastRevisionDate) {
        ...
        this.findUpdatesToTopics = function () {
        };
        this.syncTopicsCollectionWithSpec = function (updatedSpec) {
        };
        /**
        ...
        * @param updatedSpec
        */
        this.syncDomWithSpec = function (updatedSpec) {
            ...
            var specNodes = _this.getAllChildrenInFlatOrder(updatedSpec);
            ...
            */
            ...
            _.reduce(specNodesMissingDiv, function (delay, element, index) {
                var iFrame = this.buildIFrameAndDiv(element);
                this.setIFrameSrc(iFrame, delay, index);
                return delay + DELAY_BETWEEN_IFRAME_SRC_CALLS;
            }, 0, _this);
